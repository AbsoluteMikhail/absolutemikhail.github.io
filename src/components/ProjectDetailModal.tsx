        ...
        <div className="relative group/carousel bg-black aspect-video flex-shrink-0 z-10 shadow-xl overflow-hidden">
          ...
          {slides.length > 1 && <>
            <button
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-black/50 border border-white/10 flex items-center justify-center text-white md:opacity-0 md:group-hover/carousel:opacity-100 md:group-focus-within/carousel:opacity-100 opacity-100 transition-all hover:bg-primary/50 z-20"
            >
            ...
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-black/50 border border-white/10 flex items-center justify-center text-white md:opacity-0 md:group-hover/carousel:opacity-100 md:group-focus-within/carousel:opacity-100 opacity-100 transition-all hover:bg-primary/50 z-20"
            >
            ...
            <div className="flex flex-wrap justify-center gap-3 pt-6">
              {storeLinks.map((store) => (
                <a
                  ...
                  className={buttonStyles({ size: "lg", effect: "shadow", className: "group inline-flex items-center gap-2 rounded-xl font-normal" })}
                >
                  {store.label}
