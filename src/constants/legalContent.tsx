    ...
    content: (
      <>
        ...
        <section>
          ...
          <p className="mt-3">Академия сохраняет в локальном хранилище этого браузера адрес материала, процент прочитанного, раздел для продолжения и дату сохранения. Прогресс действует 180 дней с последнего продвижения по материалу, не синхронизируется между устройствами и не отправляется сайтом на сервер или в аналитику. Его можно удалить, очистив данные gamepunk.ru в настройках браузера. Если сохранение недоступно, материалы и навигация продолжают работать.</p>
