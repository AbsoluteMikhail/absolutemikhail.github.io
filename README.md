...
**Сайт доступен по адресу**: [https://gamepunk.ru](https://gamepunk.ru)
...
Правила для агентов находятся в [AGENTS.md](./AGENTS.md).
[Работа с Vikunja, Beads и LLM Wiki](./docs/agent-workflow.md) описывает постановку
задач, передачу исполнителям, отчёты и независимую приёмку.
...
© 2026 Михаил Ефремов (Absolute Mikhail).

Исходный код сайта можно изучать, использовать, изменять и распространять,
в том числе в коммерческих проектах, по [лицензии с обязательным указанием автора](./LICENSE).
Сохраняйте лицензию и благодарность «Спасибо Absolute Mikhail за исходный код — https://gamepunk.ru»
в README или документации. В публичном сайте или приложении также нужна видимая
благодарность со ссылкой — например, в подвале или разделе «Об авторстве».

Фото, тексты, видео, игры и брендинг этим разрешением не охватываются;
сторонние компоненты сохраняют собственные лицензии.
Авторские учебные примеры кода и Blueprint-графы Академии доступны отдельно
по [0BSD](./public/academy-code-license.txt), без обязательного указания автора.
